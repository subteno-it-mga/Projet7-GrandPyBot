// var test = {'pair':'chaussettes'}
// $("#bouton-magique").click(function(){
//     $.ajax({
//       type : 'GET',
//       url : '/treat',
//       dataType: "json",
...
//     /* Act on the event */
//     var afficher = $('.mytext input').attr('value');
//     console.log(afficher);
//     console.log("ouais gros");

//     $.ajax({
//     url: 'treat', //server url
//     type: 'POST',    //passing data as post method
//     dataType: 'json', // returning data as json
//     data: {"input1":$('.mytext').val()},  //form values
//     success:function(json)
//     {
//         alert(json.data);  //response from the server given as alert message
...
//             insertChat("me", text);            
//             // $.ajax({
//             //     url: 'http://127.0.0.1:5000/treat', //server url
//             //     type: 'POST',    //passing data as post method
//             //     contentType: "application/json; charset=utf-8",
//             //     dataType: 'json', // returning data as json
//             //     data:JSON.stringify({phrase:"qskjchzivehiuz"}) ,  //form values
//             //     success:function(result)
//             //     {
//             //         console.log(result);  //response from the server given as alert message
            
//             //     },
//             //     done:function(){
//             //         console.log("Oui onest là")
//             //     }
//             // });
